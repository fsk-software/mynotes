...
public class ColorSelector extends LinearLayout {
	...
	public interface OnSelectListener {
		public void onColorSelectChange(ColorSelector view, NoteColor color);
	}

	protected OnSelectListener mOnSelectListener;
	
	protected EnumMap<NoteColor,ColorButton> mColorButtons =
		new EnumMap<NoteColor,ColorButton>(NoteColor.class);
...
//		Iterator<NoteColor> iter = NoteColor.getIterator();
//		while (iter.hasNext()) {
...
//	}
//
//	public void selectColor(NoteColor color) {
...
//	}
//
//	public final boolean isColorSelected(NoteColor color) {
