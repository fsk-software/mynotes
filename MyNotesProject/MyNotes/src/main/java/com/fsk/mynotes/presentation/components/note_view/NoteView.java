...
//				if (mListener != null) {
//					mListener.onNoteClick(NoteView.this, mNote.getId());
//				}
//			}
//		});
//
...
//			public void onClick(View v) {
//				if (mListener != null) {
//					mListener.onNoteDeleteClick(NoteView.this, mNote.getId());
//				}
//			}
//		});
//	}
...
//		mNote = note;
//    	NoteColor color = NoteColor.getColor(note.getColor().);
...
//    	return NoteColor.getColor(mNote.getColor());
//    }
//
//    @Override
